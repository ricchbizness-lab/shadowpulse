...
/* ─── Icons (inline SVG — no emoji, no external lib needed) ─── */
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Navigation principale">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <a href="#" className="flex items-center gap-2 group" aria-label="ShadowPulse — Accueil">
...
function ContactSection() {
  ...
  const reassurances = [
    { icon: <IconLock size={16} className="text-[#06B6D4]" />, text: 'Données hébergées en France — HDS compatible' },
            ...
            {status === 'success' ? (
              ...
              >
                ...
                <p className="text-xs text-[#475569] leading-relaxed">
                  ...
                  <a href="#" className="text-[#2563EB] hover:underline">politique de confidentialité</a>.
    ...
    <footer className="bg-[#0B1929] border-t border-[#1E3A5F]/60 py-10" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <a href="#" className="flex items-center gap-2" aria-label="ShadowPulse — Accueil">
          ...
          <nav className="flex gap-6" aria-label="Liens légaux">
            {['Mentions légales', 'Politique de confidentialité', 'CGV'].map(link => (
              <a key={link} href="#" className="text-xs text-[#475569] hover:text-[#94A3B8] transition-colors">{link}</a>
            ))}
          </nav>
